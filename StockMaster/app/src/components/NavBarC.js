...
const pages = [
    { label: 'Acceuil', route: '/StockMaster/Dashboard' },
    { label: 'Utilisateurs', route: '/StockMaster/Users' },
    { label: 'Fournisseurs', route: '/StockMaster/Suppliers' },
    { label: 'Aricles', route: '/StockMaster/Items' },
    { label: 'Commandes', route: '/StockMaster/Orders' },
];

const settings = [
    { label: 'Profil', route: '/StockMaster/Account/Profil' },
